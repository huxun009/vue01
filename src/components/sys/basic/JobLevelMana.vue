<template>
  <div>
    <div>
      ...
      <el-select v-model="jl.titleLevel" placeholder="职称选择" size="small"
    ...
    <div style="margin-top: 10px">
      <el-table
        ...
        <el-table-column
            label="操作">
          <template slot-scope="scope">
            <el-button size="small" style="width: 50px" @click="showEditView(scope.row)">编辑</el-button>
            <el-button size="small" style="width: 50px" type="danger" @click="deleteHandler(scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      ...
      <div>
        <table>
          ...
          <tr>
            ...
            <td>
              <el-select v-model="updateJl.titleLevel" placeholder="职称选择" size="small"
                         style="margin-left: 5px;margin-right: 5px">
                <el-option
                    v-for="item in titleLevels"
                    :key="item"
